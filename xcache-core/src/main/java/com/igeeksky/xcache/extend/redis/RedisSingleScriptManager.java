 ...
 */
public class RedisSingleScriptManager implements ScriptManager {
	...
	public RedisSingleScriptManager(String name, long expiration){
		this.name = name;
