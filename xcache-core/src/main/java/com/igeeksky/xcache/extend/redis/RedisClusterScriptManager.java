...
for i in ipairs(kvs) do 
	local r={};r['@class']='com.R';local kv = kvs[i];local k = kv['k'];local local_v = kv['v'];
 ...
 */
public class RedisClusterScriptManager implements ScriptManager {
	...
	public RedisClusterScriptManager(String name, long expiration){
		this.name = name;
